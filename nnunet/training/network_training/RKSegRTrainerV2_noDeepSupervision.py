...
import torch
from nnunet.network_architecture.generic_RKSegR import Generic_RKSegR, ConvDropoutNormNonlin
...
class RKSegRTrainerV2_noDeepSupervision(nnUNetTrainerV2_noDeepSupervision):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_RKSegR(self.num_input_channels, self.base_num_features, self.num_classes,
...
class RKSegRTrainerV2_noDeepSupervision_150epochs(RKSegRTrainerV2_noDeepSupervision):
    """

...
import torch
from nnunet.network_architecture.generic_RKSegL import Generic_RKSegL, ConvDropoutNormNonlin
...
class RKSegLTrainerV2_noDeepSupervision(nnUNetTrainerV2_noDeepSupervision):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_RKSegL(self.num_input_channels, self.base_num_features, self.num_classes,
...
class RKSegLTrainerV2_noDeepSupervision_150epochs(RKSegLTrainerV2_noDeepSupervision):
    """
